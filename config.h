...
static const Key keys[] = {
    ...
    {ControlMask, XK_F6, spawn, {.v = downvol}}, // Example: Super/Alt + F6
    {ControlMask, XK_F5, spawn, {.v = mutevol}}, // Example: Super/Alt + F5
    {ControlMask, XK_F7, spawn, {.v = upvol}},   // Example: Super/Alt + F7
