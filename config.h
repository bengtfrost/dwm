...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", \
                                  col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-h", "25", NULL };
...
static const Key keys[] = {
    ...
    {MODKEY,                    XK_F11, spawn, {.v = downvol}}, // Example: Super/Alt + F11
    {MODKEY,                    XK_F9, spawn, {.v = mutevol}},  // Example: Super/Alt + F9
    {MODKEY,                    XK_F12, spawn, {.v = upvol}},   // Example: Super/Alt + F12
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
