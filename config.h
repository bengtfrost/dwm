...
static const char *fonts[]          = { "Fira Code:style=Regular:size=9" };
static const char dmenufont[]       = "Fira Code:style=Regular:size=9";
...
static const char *surf[]  = { "microsoft-edge", NULL };
